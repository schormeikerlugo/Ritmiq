...
- 2026-09-02 (Fase A): manifest enriquecido con `shortcuts`, `share_target` (GET), `launch_handler: navigate-existing`, `display_override`, `categories`, `screenshots`. Ver [[Capacidades-iOS-Fases-ABC]] y ADR-037. Commit `6452c9a`.
