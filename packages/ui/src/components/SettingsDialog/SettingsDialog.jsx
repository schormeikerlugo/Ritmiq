/**
 * Subsecciones reusables de Ajustes (Connection, Storage, Devices, etc.).
 *
 * NOTA: el componente modal SettingsDialog raiz fue eliminado en el
 * refactor a SettingsView (Spotify-style). Este archivo se mantiene
 * SOLO porque exporta funciones de seccion (PwaPairingSection,
 * PwaLanSection, PwaRemoteSection, PwaDiagnosticsSection, DevicesSection,
 * SharedCacheSection, YtDlpSection, DesktopTunnelSection,
 * DesktopAccessTokenSection) que SettingsView/sections/ConnectionSection
 * y StorageSection consumen.
 *
 * Migracion futura: estas funciones se pueden mover a
 * `components/SettingsView/sections/` cuando se rediseen usando las
 * primitivas SettingRow/SettingsGroup. Por ahora se renderean dentro
 * de un wrapper `.embed` que neutraliza estilos legacy.
 */
 ...
 */
export function DesktopTunnelSection() {
